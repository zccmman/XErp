...
为什么分层：89 个工具全量暴露给 AI，上下文成本和误调用概率都高；而个人/代账
...
三档：
    ...
    standard 标准  59 个：+ 驳回/撤回/反记账/多级签字/月结/往来/银行/OCR/三表预测/专项核算/账本精灵主动推送/AI风险预警/报税准备/审计追踪/票据入账预览门禁/应收应付对账单/应收应付账龄/应收应付未清项/核销草稿/授信额度设置/信用敞口扫描/逾期催收草稿/收款自动匹配/汇兑损益重估/子账总账对账/运营财务画像/图谱指标/实时Copilot/情景推演/异常自愈建议
    pro      专业  89 个：全量（自治授权/过账、异常扫描、适配器、转账模板、双审批通道、多主体合并报表、合并血缘下钻、合并层级标注、内部往来配对草稿、长投权益抵销草稿、合并现金流量表、合并现金流抵消草稿、应收应付核销落地、汇兑损益重估落库）
